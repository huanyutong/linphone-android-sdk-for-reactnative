package com.hyt.meeyisipsdk.settings;
...
public class LinphonePreferences {
    ...
    private void copyAssetsFromPackage() throws IOException {
        copyIfNotExist(com.hyt.meeyisipsdk.R.raw.linphonerc_default, getLinphoneDefaultConfig());
        copyFromPackage(com.hyt.meeyisipsdk.R.raw.linphonerc_factory, new File(getLinphoneFactoryConfig()).getName());
        copyIfNotExist(com.hyt.meeyisipsdk.R.raw.lpconfig, mBasePath + LINPHONE_LPCONFIG_XSD);
        copyFromPackage(
                com.hyt.meeyisipsdk.R.raw.default_assistant_create,
                new File(mBasePath + DEFAULT_ASSISTANT_RC).getName());
        copyFromPackage(
                com.hyt.meeyisipsdk.R.raw.linphone_assistant_create,
